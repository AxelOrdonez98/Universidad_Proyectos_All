...
public class TestDiaDelAño {
    public static void main (String args[]) {
        Scanner dia = new Scanner(System.in);
        int diaa,semana,diaSema = 1;
        ...
        if (diaa>=1 && diaa<=365) {
            ...
            } System.out.println("El dia es:" + diaSema);
            switch (diaSema){
                case 1 : 
                ...
                case 7 :
                    ...
                    break;
                default :
                    System.out.println("El dia es: asdfghjklñ");
                    break;
            }
        } else {
            System.out.println("El dia no esta dentro del rango [1-365]");
        }
    }
}