...
public class Persona {
    ...
    private String tieneSegundoApellido = "si";
    String curp = null;
    MisFunciones funcion = new MisFunciones();
    //--------------------------------------------
    public Persona(String nombre, String apellidoPat, String apellidoMat, String dia, String mes, String year, String estado, String genero) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Persona{" + "nombre=" + nombre + ", apellidoPat=" + apellidoPat + ", apellidoMat=" + apellidoMat + ", dia=" + dia + ", mes=" + mes + ", year=" + year + ", estado=" + estado + ", genero=" + genero + ", tieneSegundoApellido=" + tieneSegundoApellido + '}';
    }
